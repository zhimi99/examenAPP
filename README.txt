...
a persistence unit "examenChristianZhiminaicelaServidorPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "examenChristianZhiminaicelaServidor\pom.xml":
...
artifact ("examenChristianZhiminaicelaServidor.war") is already built. You can build
